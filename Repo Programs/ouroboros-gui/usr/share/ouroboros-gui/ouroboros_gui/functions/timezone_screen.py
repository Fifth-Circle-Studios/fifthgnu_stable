...
from ouroboros_gui.widgets.timezone import TimezoneEntry
...
@Gtk.Template(resource_path="/al/fifthgnu/ouroborosgui/pages/timezone/timezone_screen.ui")
class TimezoneScreen(ouroborosScreen, Adw.Bin):
    ...
    def __init__(self, window, locations, set_valid, application, **kwargs):
        ...
        builder = Gtk.Builder.new_from_resource(
            "/al/fifthgnu/ouroborosgui/pages/timezone/timezone_dialog.ui"
        )
