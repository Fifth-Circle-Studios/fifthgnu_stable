...
from ouroboros_gui.widgets.layout import KeyboardLayout
...
@Gtk.Template(resource_path="/al/fifthgnu/ouroborosgui/pages/keyboard/keyboard_screen.ui")
class KeyboardScreen(ouroborosScreen, Adw.Bin):
    ...
    def __init__(self, window, keymaps, set_valid, application, **kwargs):
        ...
        builder = Gtk.Builder.new_from_resource(
            "/al/fifthgnu/ouroborosgui/pages/keyboard/keyboard_dialog.ui"
        )
