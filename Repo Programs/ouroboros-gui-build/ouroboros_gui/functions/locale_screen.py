...
#
# Copyright 2022 axtlos <axtlos@fifthgnu.al>
...
from ouroboros_gui.widgets.locale import LocaleEntry
from ouroboros_gui.widgets.selected_locale import SelectedLocale
from ouroboros_gui.utils.gtk_helpers import set_list_text



@Gtk.Template(resource_path="/al/fifthgnu/ouroborosgui/pages/locale/locale_screen.ui")
class LocaleScreen(ouroborosScreen, Adw.Bin):
    ...
    def __init__(self, window, locations, set_valid, application, **kwargs):
        ...
        builder = Gtk.Builder.new_from_resource(
            "/al/fifthgnu/ouroborosgui/pages/locale/locale_dialog.ui"
        )
