...
@Gtk.Template(resource_path="/al/fifthgnu/ouroborosgui/pages/finished_screen.ui")
class FinishedScreen(ouroborosScreen, Adw.Bin):
    ...
    def output(self, widget):
        with open("/tmp/ouroboros-gui-output.txt", "r") as f:
            output = f.read()
        LogWindow(window=self.window, title="ouroboros log view", content=output).present()
