...
@Gtk.Template(resource_path="/al/fifthgnu/ouroborosgui/pages/install_screen.ui")
class InstallScreen(OuroborosScreen, Adw.Bin):
    ...
    def on_show(self):
        ...
        with open(os.getenv("HOME") + "/.config/ouroboros.json", "w") as f:
            f.write(prefs)
        ...
        self.vte_instance.spawn_async(
            ...
            ".",  # working directory
            ["bash", "/usr/share/ouroboros-gui/ouroboros_gui/scripts/install.sh"],
            [],  # environment
