...
from ouroboros_gui.classes.install_prefs import InstallPrefs
...
@Gtk.Template(resource_path="/al/fifthgnu/ouroborosgui/pages/summary_screen.ui")
class SummaryScreen(OuroborosScreen, Adw.Bin):
    ...
    def on_show(self):
        ...
        for i in range(0, len(self.window.available_partitions)):
            ...
            partitions.append(partition.generate_ouroboros_entry())
