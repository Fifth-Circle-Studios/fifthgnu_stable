...
from ouroboros_gui.classes.partition import Partition
from ouroboros_gui.widgets.desktop import DesktopEntry
from ouroboros_gui.widgets.disk import DiskEntry
from ouroboros_gui.widgets.partition import PartitionEntry
from ouroboros_gui.functions.keyboard_screen import KeyboardScreen
from ouroboros_gui.functions.timezone_screen import TimezoneScreen
from ouroboros_gui.functions.locale_screen import LocaleScreen
from ouroboros_gui.functions.user_screen import UserScreen
from ouroboros_gui.functions.desktop_screen import DesktopScreen
from ouroboros_gui.functions.misc_screen import MiscScreen
from ouroboros_gui.functions.partition_screen import PartitionScreen
from ouroboros_gui.functions.summary_screen import SummaryScreen
from ouroboros_gui.functions.install_screen import InstallScreen
from ouroboros_gui.functions.finished_screen import FinishedScreen
from ouroboros_gui.functions.welcome_screen import WelcomeScreen
from ouroboros_gui.classes.ouroboros_screen import OuroborosScreen
from ouroboros_gui.locales.locales_list import locations
from ouroboros_gui.keymaps import keymaps
from ouroboros_gui.desktops import desktops
from ouroboros_gui.utils import disks
from ouroboros_gui.utils.threading import RunAsync


@Gtk.Template(resource_path="/al/fifthgnu/ouroborosgui/window.ui")
class OuroborosGuiWindow(Gtk.ApplicationWindow):
    __gtype_name__ = "OuroborosGuiWindow"
    ...
    def _get_current_page(self, offset=0) -> OuroborosScreen:
        current_index = self.carousel.get_position()
        return self.carousel.get_nth_page(current_index + offset)

    def on_page_change(self, page: OuroborosScreen):
    ...
    def show_about(self, *_):
        builder = Gtk.Builder.new_from_resource("/al/fifthgnu/ouroborosgui/about.ui")
