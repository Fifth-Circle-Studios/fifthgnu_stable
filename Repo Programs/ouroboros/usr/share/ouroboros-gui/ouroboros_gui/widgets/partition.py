...
from ouroboros_gui.manualpartitioning import filesystems, mountpoints
from ouroboros_gui.classes.partition import Partition


@Gtk.Template(resource_path="/al/fifthgnu/ouroborosgui/widgets/partition.ui")
class PartitionEntry(Adw.ActionRow):
    ...
    def on_filesystem_select(self, widget):
        ...
        print("select " + self.partition.generate_ouroboros_entry())
