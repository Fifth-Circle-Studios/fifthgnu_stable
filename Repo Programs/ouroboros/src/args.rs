...
#[derive(Debug, Parser)]
#[clap(name="ouroboros", version=env!("CARGO_PKG_VERSION"), about=env!("CARGO_PKG_DESCRIPTION"), author=env!("CARGO_PKG_AUTHORS"))]
pub struct Opt {
    #[clap(subcommand)]
    pub command: Command,
...
pub enum Command {
    ...
    /// Read Ouroboros installation config
    #[clap(name = "config")]
    Config {
...
pub struct PartitionArgs {
    /// If Ouroboros should automatically partition (mode = auto)
...
pub struct UnakiteArgs {
    ...
    #[clap(long)]
    pub root: String,
    /// Root device of Fifth Circle GNU
    #[clap(long)]
    pub oldroot: String,
