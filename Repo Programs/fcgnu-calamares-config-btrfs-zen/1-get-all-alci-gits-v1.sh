...
directories=(
fcgnu-calamares-config/
fcgnu-calamares-config-dev/
fcgnu-calamares-config-hardened/
fcgnu-calamares-config-lts/
fcgnu-calamares-config-pure/
fcgnu-calamares-config-xanmod/
fcgnu-calamares-config-zen/
alci-dwm/
alci-dwm-nemesis/
alci-grub-theme/
alci-iso/
